...
namespace Sistema.Presentacion
{
    public partial class FrmArticulos : Form
    {
        ...
        {
            cmdCategorias.DataSource = NArticulo.CargarCategorias();
            cmdCategorias.ValueMember = "idcategoria";
            cmdCategorias.DisplayMember = "nombre";
        ...
        private void Insertar()
        {
            ...
            try
            {
                ...
                if (txtNombre.Text == string.Empty || cmdCategorias.Text == string.Empty || txtPrecioVenta.Text == string.Empty || txtStock.Text == string.Empty)
                {
                ...
                else
                {
                    ...
                    respuesta = NArticulo.Insertar(txtNombre.Text.Trim(), txtDescripcion.Text,
                        Convert.ToInt32(cmdCategorias.SelectedValue), txtCodigo.Text,
                        Convert.ToDecimal(txtPrecioVenta.Text.Trim()), Convert.ToInt32(txtStock.Text.Trim()), txtImagen.Text);
        ...
        private void Actualizar()
        {
            try
            {
                ...
                {
                    respuesta = NArticulo.Actualizar(txtNombre.Text.Trim(), txtDescripcion.Text,
                        Convert.ToInt32(cmdCategorias.SelectedValue), txtCodigo.Text,
                        Convert.ToDecimal(txtPrecioVenta.Text.Trim()), Convert.ToInt32(txtStock.Text.Trim()), txtImagen.Text, Convert.ToInt32(txtId));
